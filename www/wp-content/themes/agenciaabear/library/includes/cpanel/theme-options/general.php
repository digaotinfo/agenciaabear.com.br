<div class="kopa-content-box tab-content tab-content-1" id="tab-general">
    ...
    <div class="kopa-box-body">
        ...
        <div class="kopa-element-box kopa-theme-options">
            ...
            <input type="text" value="<?php echo get_option('kopa_theme_options_headline_title', __( 'Breaking News', kopa_get_domain() )); ?>" id="kopa_theme_options_headline_title" name="kopa_theme_options_headline_title">
        </div>
        <div class="kopa-element-box kopa-theme-options">
