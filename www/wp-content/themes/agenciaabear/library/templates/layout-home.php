...
<?php if ( is_active_sidebar( $sidebars[4] ) || is_active_sidebar( $sidebars[5] ) || is_active_sidebar( $sidebars[6] ) || is_active_sidebar( $sidebars[7] ) || is_active_sidebar( $sidebars[8] ) ) { ?>
...
<?php if ( is_active_sidebar( $sidebars[9] ) ) { ?>
    <div class="widget-area-11">
        <div class="wrapper">
            <?php dynamic_sidebar( $sidebars[9] ); ?>
        </div>
        <!-- wrapper -->
    </div>
    <!-- widget-area-11 -->
